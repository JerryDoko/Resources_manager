...
export default function SeriesDetailPage({
  ...
  const { tags, refresh, refreshTags, setMusicQueue } = useLibrary();
  ...
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-[var(--line)] bg-[#f7f9f8]/90 backdrop-blur-xl">
      ...
      {data && (
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-8 lg:grid-cols-[320px_1fr]">
          {/* Cover + meta — Finder-style detail pane */}
